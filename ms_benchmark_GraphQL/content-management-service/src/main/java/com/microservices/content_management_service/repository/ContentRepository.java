...
public interface ContentRepository extends JpaRepository<Content, Long> {
       ...
       /**
        * Silinmemiş ve aktif içerikleri bul (ilişkilerle birlikte)
        */
       @Query("SELECT DISTINCT c FROM Content c " +
                     ...
                     "WHERE c.deletedAt IS NULL AND c.isActive = true ORDER BY c.createdAt DESC")
       ...
       /**
        * Öne çıkan/Önerilen içerikler için son eklenen 100 aktif içeriği getir.
        * İlişkileri lazy load ile çekecek (Service katmanında @Transactional içinde).
        */
       List<Content> findTop100ByIsActiveTrueAndDeletedAtIsNullOrderByCreatedAtDesc();

       /**
        * Öne çıkan/Önerilen içerikler için son eklenen 10 aktif içeriği getir.
        * İlişkileri lazy load ile çekecek (Service katmanında @Transactional içinde).
        */
       List<Content> findTop10ByIsActiveTrueAndDeletedAtIsNullOrderByCreatedAtDesc();
}
