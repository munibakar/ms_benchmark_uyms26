...
import com.microservices.content_management_service.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleLazyInitializationException(
        ...
        log.error("LazyInitializationException occurred: {}", ex.getMessage(), ex);
        
        ErrorResponse errorResponse = ErrorResponse.builder()
                .timestamp(LocalDateTime.now())
                .status(HttpStatus.INTERNAL_SERVER_ERROR.value())
                .error(HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase())
                .message("Veri yükleme hatası. Lütfen tekrar deneyin.")
                .path(request.getRequestURI())
                .build();
